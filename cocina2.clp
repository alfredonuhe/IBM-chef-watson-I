...
(defrule resultado-receta-Nueva
(declare (salience 15))
...
(object (is-a PASO) (id_receta ?idr) (orden ?o) (descripcion ?desc) (nombre_ingrediente ?i1))
...
=>
(modify-instance ?b (contado hecho))
